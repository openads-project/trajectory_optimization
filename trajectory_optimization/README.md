...
2. Add the nwe model / parameterization in the [ocp_model_handler.hpp](./include/trajectory_optimization/ocp_model_handler.hpp#L28-L35) and extend the wrapper functions accordingly.