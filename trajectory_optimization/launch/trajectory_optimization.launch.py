...
def generate_launch_description_with_resolved_launch_args(launch_context):
    ...
    remappable_topics = [
        ...
        DeclareLaunchArgument("ego_obbs_topic", default_value="~/visualization/ego_obbs"),
        DeclareLaunchArgument("object_obbs_topic", default_value="~/visualization/object_obbs"),
    ]
