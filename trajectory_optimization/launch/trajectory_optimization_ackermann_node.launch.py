...
def generate_launch_description():
    ...
    params_arg = DeclareLaunchArgument('params', default_value=PathJoinSubstitution([
        get_package_share_directory("trajectory_optimization"), "config", "params_ackermann.yml"])
    )
    node_name_arg = DeclareLaunchArgument('node_name', default_value='trajectory_optimization_ackermann_node')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable="trajectory_optimization_ackermann_node",
