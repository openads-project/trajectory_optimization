...
def set_model(ocp, config):
    ...
    p_ref_point = MX.sym('ref_point', np.prod(config['p_ref_point_shape'])) # (x, y, v)
    ...
    params = vertcat(p_cost_weights, p_dynamic_weight, p_ref_path, p_ref_point, p_obstacles, p_cost_params)
    model.p = params
