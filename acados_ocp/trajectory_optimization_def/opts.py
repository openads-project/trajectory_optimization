...
def set_opts(ocp, config):
    ...
    opts.levenberg_marquardt = 0.01             # default. Larger values could help to solve the problem if 0 fails, but will be slower
