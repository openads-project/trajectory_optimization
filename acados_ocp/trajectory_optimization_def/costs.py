...
def set_costs(ocp, config):
    ...
    n_params = n_params_cost_weights + n_params_ref_path + n_params_max_vel + n_params_s_ref
    ...
    p_s_ref = ocp.model.p[n_params_cost_weights + n_params_ref_path + n_params_max_vel:n_params]
    ...
    # cost functions
    ocp.model.cost_expr_ext_cost = w_lon * dlon_term + w_lat * dlat_term + w_x * x_term + w_y * y_term + w_v * v_term + w_v_max * v_max_term
    ocp.model.cost_expr_ext_cost_0 = w_lon * dlon_term + w_lat * dlat_term +  w_x * x_term + w_y * y_term + w_v * v_term + w_v_max * v_max_term
    ocp.model.cost_expr_ext_cost_e = w_lon * dlon_term + w_lat * dlat_term + w_x * x_term + w_y * y_term + w_v * v_term + w_v_max * v_max_term + w_s_ref * s_ref_term
